...
class testRecipe(TestCase):
    ...
    def addNewRecipe(self, title, ingredients, time = 10, level = 1):
        self.recipe = Recipe.objects.update_or_create(recipe_title = title, preparation_time = time, difficulty_level = level)[0]
    ...
    def test_is_recipe_title_unique(self):
        try:
            ...
            self.fail("Recipe titles aren unique!")
        except:
            pass
    ...
    def test_get_filtered_recipes_with_valid_ingredient(self):
        ...
        # self.assertNotIn("Bananowy deser z czerwonych bananow", str(results)) --IMHO TO POWINNO TEZ DZIALAC I TAK SAMO Z LISTA NIEPOZADANYCH
    ...
    def test_get_filtered_recipes_difficult(self):
        ...
        self.assertEqual(1, Recipe.get_filtered_recipes(difficulty_level = 0).count()) #Byc moze nie powinno akceptowac lvl innych niz [1,2,3]
